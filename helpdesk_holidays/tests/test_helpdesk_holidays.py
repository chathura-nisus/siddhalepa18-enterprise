...
class TestHelpdeskHolidays(HelpdeskCommon, TestHrHolidaysCommon):
    ...
    @freeze_time('2022-03-7')
    def test_assignment_global_leave(self):
        """Test that tickets are still assigned when there is a global leave"""
        ...
        self.assertIn(self.new_ticket().user_id, [self.user_hruser, self.user_hrmanager, self.user_employee], "The created ticket should be automatically assigned to a user even if there is a global leave")
